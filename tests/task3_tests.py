...
class TestPokeTeam(BaseTest):
    ...
    def test_random_team(self):
        ...
        t = PokeTeam.random_team("Bob", 0, 4)
    ...
    def test_special(self):
        ...
        # test battle mode 1 special swaps the first and second halves of the team
        # and reverses the order of the previously front half
